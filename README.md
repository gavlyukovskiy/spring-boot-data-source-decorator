...
* to use with Spring Boot 2.x.x - 1.5.6
...
```groovy
compile('com.github.gavlyukovskiy:datasource-proxy-spring-boot-starter:1.5.6')
```
```xml
<dependency>
    <groupId>com.github.gavlyukovskiy</groupId>
...
```groovy
compile('com.github.gavlyukovskiy:flexy-pool-spring-boot-starter:1.5.6')
```
```xml
<dependency>
    <groupId>com.github.gavlyukovskiy</groupId>
