...
* to use with Spring Boot 2.x.x and Spring Cloud Finchley - 1.5.0
...
```groovy
compile('com.github.gavlyukovskiy:p6spy-spring-boot-starter:1.5.0')
```
```xml
<dependency>
...
```groovy
compile('com.github.gavlyukovskiy:datasource-proxy-spring-boot-starter:1.5.0')
```
```xml
<dependency>
    <groupId>com.github.gavlyukovskiy</groupId>
...
```groovy
compile('com.github.gavlyukovskiy:flexy-pool-spring-boot-starter:1.5.0')
```
```xml
<dependency>
    <groupId>com.github.gavlyukovskiy</groupId>
