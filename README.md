...
* to use with Spring Boot 1.x.x - 1.3.3
* to use with Spring Boot 2.x.x - 1.4.1
...
```groovy
compile('com.github.gavlyukovskiy:datasource-proxy-spring-boot-starter:1.4.1')
```
```xml
<dependency>
    <groupId>com.github.gavlyukovskiy</groupId>
...
```groovy
compile('com.github.gavlyukovskiy:flexy-pool-spring-boot-starter:1.4.1')
```
```xml
<dependency>
    <groupId>com.github.gavlyukovskiy</groupId>
